...
import Pic1 from '../../public/ss1.png'
import Pic2 from '../../public/ss2.png'
import Pic3 from '../../public/ss3.png'
import Image from "next/image"

export default function BirthdayCelebration2() {
    ...
    <div className="flex flex-col items-center">
      ...
      >
        <div className="flex gap-1">
          <Image src={Pic1} alt="image" width={150} height={150}/>
          <Image src={Pic2} alt="image" width={150} height={150}/>
          <Image src={Pic3} alt="image" width={150} height={150}/>
        </div>
      </motion.div>
    </div>
  )
